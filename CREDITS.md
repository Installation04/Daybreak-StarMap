...
- **Gaia DR3 shell**: Gaia Collaboration, Vallenari, A., et al. 2023, A&A, 674, A1, "Gaia Data Release 3: Summary of the content and survey properties", queried from the ESA Gaia Archive, https://gea.esac.esa.int/archive/ (gaiadr3.gaia_source). The 713,166 stars between 100 and 200 pc (326 to 652 ly) brighter than G = 16, with parallax over error above 5, that neither AT-HYG nor GCNS carries. Each is placed by its Gaia DR3 parallax; V is derived from G and BP-RP by a fit on the stars the catalogues share; they carry their Gaia DR3 source id and no other designation.
